                    ...
                    <div class="carousel carousel-end rounded-box">
                        <div class="carousel-item px-2 ">
                            <div class="card bg-gray-100  w-96">
                                <figure>
                                    <img src="https://pansiona.ir/wp-content/uploads/2018/12/fatemi.jpg"
                                        alt="خوابگاه دانشجویی" />
                                </figure>
                                <div class="card-body">
                                    <h2 class="">اطلاعیه خوابگاه دانشجویی</h2>
                                    <p>... دانشجوی عزیز جهت بهره مندی از تخفیف</p>
                                    <div class="card-actions justify-end">
                                        <a href="https://golestan.khu.ac.ir/home/Default.htm"><button class="btn btn-secondary">مشاهده بیشتر</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
